...
- 로컬용 환경을 정의합니다.
- 8081 포트를 통해 nginx에 접근하며, 페이지 접근시 local-html 파일이 보여지게 됩니다.
...
- 개발용 환경을 정의합니다.
- 8081 포트를 통해 nginx에 접근하며, 페이지 접근시 dev-html 파일이 보여지게 됩니다.
...
- 운영용 환경을 정의합니다.
- 8082 포트를 통해 nginx에 접근하며, 페이지 접근시 prod-html 파일이 보여지게 됩니다.
